Events.on(ClientLoadEvent, () => {
    graphics.category("cursor-renderer");

    graphics.sliderPref("cursor-renderer-text-alpha", 50, 0, 100, 5, v -> v + "%");
    graphics.sliderPref("cursor-renderer-line-alpha", 50, 0, 100, 5, v -> v + "%");
